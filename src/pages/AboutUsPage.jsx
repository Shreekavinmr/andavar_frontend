...
//     <div
//       ref={ref}
//       className={`value-card ${isVisible ? 'value-visible' : ''}`}
//     >
...
//       icon: <Heart size={36} />,
//       title: "Compassion",
//       description: "Putting patient welfare at the center of our research."
//     },
//     {
...
//       icon: <Globe size={36} />,
//       title: "Innovation",
//       description: "Continuously seeking better ways to advance medical research."
//     }
//   ];

  return (
    <div className="about-us-page">
      {/* Clinical Research Hero Section */}
      <section className="clinical-hero-section">
        <div className="clinical-bg-overlay"></div>
        <div className="clinical-geometric-patterns">
          <div className="dna-helix dna-helix-1"></div>
          <div className="dna-helix dna-helix-2"></div>
        </div>
        <div className="container">
          <div className="clinical-hero-content animate-fade-in">
            <div className="clinical-hero-text">
              <h1>Pioneering Clinical Research</h1>
              <p>
                V&S Global Solutions drives cutting-edge clinical trials, advancing 
                medical innovation to transform patient outcomes globally.
              </p>
              <a href="/contact" className="clinical-hero-cta">
      ...
      {/* <section className="choose-us-section">
        <div className="animated-bg choose-us-animated-bg"></div>
        <div className="container">
          <SectionHeading 
            title="Why Choose Us" 
            subtitle="What sets V&S Global Solutions apart in clinical research"
          />
