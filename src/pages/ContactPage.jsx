...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    // Note: Actual form submission would require a backend service
    alert('Form submission would be handled here. For demonstration, form data is logged to console.');
        ...
        <div className="container">
          ...
          <div className="contact-grid">
            ...
            <div className="contact-info-card">
              ...
              <h3>Phone</h3>
              <p><a href="tel:+919074047489">+91 9074047489</a></p>
            </div>
            <div className="contact-info-card">
              <div className="contact-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <h3>Email</h3>
              <p><a href="mailto:info@vsglobalsolutions.com">info@vsglobalsolutions.com</a></p>
            </div>
          </div>
        </div>
      </section>
